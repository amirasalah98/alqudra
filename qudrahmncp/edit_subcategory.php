...
{
$add_category=$operation->edit_subcategry($_POST,$_FILES);
//echo $add_category;
 if($add_category)
 {
...
if(isset($_GET['id']))
{
$bpgr_subcategories=$operation->getdata_1('alqudrah_subcategories','*','id',$_GET['id'],$cond);
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr  >
	...
	?>
        ...
        <option value="<?=$id?>" <? if($id==$bpgr_subcategories['cat_id']){ echo 'selected="selected"';} ?> >
          <?=stripslashes($name)?>
          </option>
        <? }?>
      </select></td>
