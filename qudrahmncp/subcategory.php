...
{
 extract($_GET);
 $sp_services=$operation->getdata('alqudrah_products','*','sub_id',$del_id,$cond);
 ...
 $deletef=$operation->delete('alqudrah_products','sub_id',$del_id);
 $delete=$operation->delete('alqudrah_subcategories','id',$del_id);
 if($delete)
 {
...
$page = $_GET['page'];
	if($page) 
		...
		$start = 0;		
$targetpage = "subcategory.php";


$disp_page=$operation->paging('alqudrah_subcategories',$primary,$id,$cond,$targetpage,$var,$limit);
//echo 'disp_page='.$disp_page;
//if(isset($disp_page)&&$disp_page!='')
//{
//$ordr='order by `category_order` desc';
$date=$operation->getdata('alqudrah_subcategories','*',$primary,$id,$cond,$ordr,$start,$limit);
//echo 'start=='.$start;
//echo 'limit=='.$limit;
//}
    ...
    <td width="80%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
		...
		<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0" class="bdr">
		  <tr>
              <td align="left" valign="middle" class="right_tile"  style="color:#FFFFFF">Manage SubCategory </td>
			   <td align="left" valign="middle" class="right_tile"  style="color:#FFFFFF"><a href="add_subcategory.php" style="text-decoration:none; color:#FFFFFF;">Add SubCategory</a></td>
            ...
            <tr  >
              <td width="21%" align="center" valign="middle" class="right_tile"  style="color:#FFFFFF">SubCategory Name </td>
		...
		<? if(count($date)>0){ foreach($date as $key=>$val){ extract($val);?>	
            <tr>
			  ...
			  <td align="center" valign="middle"  class="tdstyl_r"><a href="edit_subcategory.php?id=<?=$id?>&amp;catid=<?=$category_id?>"><img src="images/images.jpeg" border="0"/></a></td>
			  <td align="center" valign="middle" class="tdstyl_r"><a href="subcategory.php?fn=del&amp;del_id=<?=$id?>&amp;del_img=<?=$image_logo?>" onclick="return confirm('Are you sure you want to delete?')"><img src="images/DeleteRed.png"  border="0"/></a></td>
				<td align="left" valign="top" class="tdstyl_r">&nbsp;</td>
