<?
include('../admin/admin/operation.php');
...
<table width="755" style="border-collapse: collapse" bordercolor="#FFFFFF" cellpadding="5" cellspacing="0" border="1" class="fontTable" id="tblfirst">
  ...
  <tr> 
     <form method="post" action="../admin/EditItem.asp" target="_self">
      ...
      <p align="center"><a href="../admin/ViewInDetail_cust.php?ID=<?=$id?>&amp;cat_id=<?=$cat_id?>&amp;sub_id=<?=$sub_id?>"><img border="0" src="../admin/photo.jpg"></a>
      <a href="../admin/ViewInDetail_cust.php?ID=<?=$id?>&amp;cat_id=<?=$cat_id?>&amp;sub_id=<?=$sub_id?>">Details&gt;&gt;</a>
      </td>
    </form>
  </tr><? }?>
</table>